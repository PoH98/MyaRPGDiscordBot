...
namespace MyaDiscordBot.Commands
{
    public class Shop : ICommand
    {
        ...
        public async Task Handler(SocketSlashCommand command, DiscordSocketClient client)
        {
            ...
            builder.WithButton("光屬性裝備", "shopEle-light").WithButton("暗屬性裝備", "shopEle-dark").WithButton("風屬性裝備", "shopEle-wind").WithButton("火屬性裝備", "shopEle-fire").WithButton("地屬性裝備", "shopEle-earth").WithButton("水屬性裝備", "shopEle-water").WithButton("道具/消耗品", "shopType-none-none");

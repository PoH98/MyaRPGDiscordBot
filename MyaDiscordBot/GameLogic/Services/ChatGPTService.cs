        ...
        public async Task<string> GetResponse(string message, string username)
        {
            ...
            var response = await ChatGpt.ChatCompletion.CreateCompletion(new ChatCompletionCreateRequest
            {
                Messages = new List<ChatMessage>
                {
                    ...
                    "Mya likes to play poops and having a smelly legs. You are one of the member of 幻花茶屋, which having other members named as Rumii (瑠美), Rabbi (拉比), Luna (露娜). Answer your fans like you are in Mya's Discord chatting with them with Cantonese."),
